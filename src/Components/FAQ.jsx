...
const FAQ = () => {
  return (
    <div className="flex flex-col mx-10 lg:mx-auto justify-center items-center">
      <div className='flex flex-col justify-center items-center lg:w-full max-md:ml-0 max-md:w-full'>
        <div className="shrink-0 mt-20 max-w-full h-px border border-solid bg-slate-600 border-slate-600 w-[100%] md:w-[878px] max-md:mt-10" />
